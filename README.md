...
## Description
This project fine-tunes the [SpeechT5](https://huggingface.co/microsoft/speecht5_tts) model for text-to-speech synthesis using my own voice in the Czech language. The Hugging Face ecosystem 🤗 was used primarily used for fine-tunning. The main inspiration and reference for this work was [this tutorial](https://github.com/emirhanbilgic/Turkish-TTS).
